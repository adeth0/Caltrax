...
const FOODS: SeedFood[] = [
  ...
  // --- Additional proteins & staples (recipe variety) ---
  {
    slug: "cod-raw",
    name: "Cod, raw",
    category: "protein",
  ...
  {
    slug: "breadcrumbs-whole-wheat",
    name: "Breadcrumbs, wholewheat",
    category: "grain",
    caloriesPer100g: 340,
    proteinPer100g: 13.0,
    carbsPer100g: 65.0,
  ...
  {
    slug: "mushroom-portobello-raw",
    name: "Portobello mushroom, raw",
    category: "vegetable",
    caloriesPer100g: 26,
    proteinPer100g: 2.5,
    carbsPer100g: 4.3,
  ...
  // --- Round 2 staples (more cuisine variety) ---
  {
    slug: "smoked-salmon",
    name: "Smoked salmon",
    category: "protein",
  ...
  {
    slug: "wholewheat-crackers",
    name: "Wholewheat crackers",
    category: "grain",
    caloriesPer100g: 420,
    proteinPer100g: 9.0,
    carbsPer100g: 68.0,
  ...
  // --- Round 3 staples (world cuisine variety) ---
  {
    slug: "dates-dried",
    name: "Dates, dried",
    category: "fruit",
