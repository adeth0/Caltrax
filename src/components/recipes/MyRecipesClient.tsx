...
import { RecipeCollectionsSection, type RecipeCollectionSummary } from "./RecipeCollectionsSection";
 ...
 * Both are still just one screen away from being logged. Collections
 * sit above both, since they can cross-cut saved and created recipes
 * alike.
 */
export function MyRecipesClient({ savedRecipes, createdRecipes, collections }: MyRecipesClientProps) {
  const isEmpty = savedRecipes.length === 0 && createdRecipes.length === 0;

  return (
    <div className="flex flex-col gap-6">
      <RecipeCollectionsSection collections={collections} />
